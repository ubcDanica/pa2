...
namespace filler
{
        ...
        */
        ...
        animation fillCustomDFS(PNG& writeImg, PNG& readImg, int x, int y, double tolerance, int frameFreq);
        animation fillCustomBFS(PNG& writeImg, PNG& readImg, int x, int y, double tolerance, int frameFreq);
    ...
    bool Add(PNG& img, int x,int y,double tolerance, HSLAPixel *center, std::vector<std::vector<int>> &marked,
                     int &fill, int frameFreq, OrderingStructure<std::pair<int,int>> &ordering, animation &anim,
